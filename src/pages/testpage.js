...
const TestPage = () => (
  <Layout>
    ...
    <p>Whether you want to improve your consumer experience online or just enjoy yourself by playing your favorite casino games without any fuss, ewallets must be your default payment processing option. It doesn’t matter where you live & it doesn’t matter why you do it, having an ewallet account in 2019 is virtually mandatory. </p>
    ...
    <p>An ewallet or a digital wallet is nothing more than a web application developed by a payment processing company that greatly facilitates the communication between a buyer and a seller. It’s an online account where you can manage your money just as you would with a normal wallet. You take some cash with you or you grab your credit/debit card, depending on the situation, you place it in your wallet, and start spending. The same applies to a digital wallet. After you’ve created your account following some simple steps - in most cases, just typing your name, e-mail address, and password - you can top-up your ewallet by adding funds via a variety of sources likebank transfer, credit/debit card, or even the trending prepaid vouchers like paysafecard or neosurf.</p>
    <div class="center-image" style={{ maxWidth: `300px`, marginBottom: `1.45rem` }}>
    <ImageFour /> </div>
    ...
    <a class="button" href="/paypal/">Read More</a></div></article>
  </div>
  <div class="slide4">
  <article class="article-style">
