...
const PageNine = () => (
  <Layout>
    <SEO title="Blog post 1" />
    <div class="ecocontent">
    <h1>Is Bitcoin The Future Of Online Paymants?</h1>
    <p class="time"><svg class="contentIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path><path d="M0 0h24v24H0z" fill="none"></path><path d="M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path></svg>Tuesday, July 9th, 2019, 5:32:05 PM</p>
      <Image />      
      <p>Bitcoin may be the future but what about now? Is there a viable option to spend Bitcoin on a wide variety of goods & services? Indeed there is: just use the interface of a couple of familiar ewallets.</p>
      <article class="side-article">
      <a href="/" class="blog-a">Choose The Best eWallet For Your Specific Needs</a>
      <Link to="/"><ImageTwo /></Link>>      
      <p>What is the best ewallet out there? It depends from person to person, from one location to another. Find out which ewallet is best for you now!</p>
      <p class="time"><svg class="contentIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path><path d="M0 0h24v24H0z" fill="none"></path><path d="M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path></svg>Tuesday, July 9th, 2019, 5:32:05 PM</p>
      </article>
          <article class="side-article">
      <a href="/" class="blog-a">3 Steps To Secure Your eWallet Money Even Further</a>
      <Link to="/"><ImageThree /></Link>>      
      <p>It’s better to be safe than sorry! Take these three steps to further improve the security of your favorite ewallet and never worry about your money ever again.</p>
      <p class="time"><svg class="contentIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path><path d="M0 0h24v24H0z" fill="none"></path><path d="M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path></svg>Tuesday, July 9th, 2019, 5:32:05 PM</p>
      </article></div>
    <aside class="sideBar">
    <div class="wrap">
